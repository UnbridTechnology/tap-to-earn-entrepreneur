import{a as P}from"./chunk-PHI3EH5S.js";import{a as c,b as x}from"./chunk-2HRH4VFT.js";import{A as u,C as d,G as A,J as k,K as m,u as n}from"./chunk-DBVODW2D.js";import{B as O,C as _,H as j,P as L,T,Y as E,a as S,aa as p,ha as $}from"./chunk-BHCFWONM.js";var D=(function(e){return e.approve="approved",e.bought="bought",e.borrow="borrowed",e.burn="burnt",e.cancel="canceled",e.claim="claimed",e.deploy="deployed",e.deposit="deposited",e.execute="executed",e.mint="minted",e.receive="received",e.repay="repaid",e.send="sent",e.sell="sold",e.stake="staked",e.trade="swapped",e.unstake="unstaked",e.withdraw="withdrawn",e})(D||{});var U=d`
  :host > wui-flex {
    display: flex;
